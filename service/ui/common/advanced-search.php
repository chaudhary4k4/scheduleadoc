...
for($i=0;$i<$end;$i++);
{
 ...
 $msg.="<li class='Doc".$value['doctorID']."' style='max-height:208px;margin-top: 1px; position:relative;'>
                     <div class=\"dr_pfl_thumbli_clm1\">
					  <div class=\"dr_prfl_crcl\">".$kk."</div>
                        ...
                        <div class=\"dr_pfl_btn\">
                           <a href=".WEB_ROOT."view-prrofile/".$value['doctorID']." class=\"dr_view\">View profile</a>
