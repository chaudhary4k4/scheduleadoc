   ...
   $('#go_btn').live('click',function(){
                  ...
                  <div class="styled-selected">
                     <select class="input-block-level" name="insuranceSelect" id="insuranceSelect">
                        ...
                        <?php $scad->listbox('location','id','name','`parent_id`=0','`name` ASC',$selected=NULL); ?>
                     </select>
                  </div>
                  ...
                  <div class="styled-selected">
                     <select id="srchLanguage" name="language" class="select2_dr">
						...
						<?php $scad->listbox('location','id','name',$condition=NULL,'`name` ASC',$selected=NULL);?>
                     </select>
                  </div>
                  <div class="styled-selected">
...
<section class="team-modern-12" >
   <div class="container">
      <div class="container1">
         <div class="jumbotron">
            <h1> Find Doctors by Locations  </h1>
         </div>
